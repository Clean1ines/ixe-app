...
class ImageScriptProcessor(IHTMLProcessor):
    ...
    async def process_html_block(
        ...
        qblock: Tag,
        block_index: int,
        subject_info: 'SubjectInfo', # Используем строковую аннотацию для избежания циклических импортов
        base_url: str,
        **kwargs
    ) -> Dict[str, Any]:
        """
        ...
        """
        logger.debug(f"Processing images for block {block_index} in subject {subject_info.alias}.")
